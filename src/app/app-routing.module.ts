...
const routes: Routes = [
  ...
  {
    path: "infomodal",
    loadChildren: "./infomodal/infomodal.module#InfomodalPageModule"
  },
  ...
  {
    path: "wishcash",
    loadChildren: "./wishcash/wishcash.module#WishcashPageModule"
  },
  {
    path: "applypromo",
  ...
  },
  {
    ...
    loadChildren:
      "./notificationssettings/notificationssettings.module#NotificationssettingsPageModule"
  },
  {
    path: "emailsettings",
    loadChildren: "./emailsettings/emailsettings.module#EmailsettingsPageModule"
  },
  {
    path: "addressbook",
  ...
  },
  {
    path: "managepayments",
    loadChildren:
      "./managepayments/managepayments.module#ManagepaymentsPageModule"
  },
  {
    path: "newpayment",
    loadChildren: "./newpayment/newpayment.module#NewpaymentPageModule"
  },
  {
    path: "datacontrol",
    loadChildren: "./datacontrol/datacontrol.module#DatacontrolPageModule"
  },
  {
    path: "currencysettings",
    loadChildren:
      "./currencysettings/currencysettings.module#CurrencysettingsPageModule"
  },
  {
    path: "accountsettings",
    loadChildren:
      "./accountsettings/accountsettings.module#AccountsettingsPageModule"
  },
  {
    path: "country",
  ...
  {
    path: "changeemail",
    loadChildren: "./changeemail/changeemail.module#ChangeemailPageModule"
  },
  {
    path: "changepassword",
    loadChildren:
